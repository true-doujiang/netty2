...
public abstract class Serializer {
    ...
    /**
     *  当要序列化一个对象的时候 obj.getBytes() 初始化
     */
    protected ChannelBuffer writeBuffer;

    /**
     * 当要反序列化一个对象的时候 obj.readFromBytes() 初始化
     */
    ...
    public ChannelBuffer writeToLocalBuff() {
        ...
        // 这个也可以啊
        //writeBuffer = ChannelBuffers.dynamicBuffer();
        write();
        return writeBuffer;
    }

    /**
     * 写入目标buff   被序列化对象的属性也是一个对象时调用的
     *
     * @param buffer
     * @return
     */
